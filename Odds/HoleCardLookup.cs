...
namespace Bot.Odds
{
    internal static class HoleCardLookup
    {
        ...
        private static void LoadTable()
        {
            ...
            var words = data.Split(new[] {Environment.NewLine, "\r", "\r\n", "\n"}, StringSplitOptions.RemoveEmptyEntries).ToList();
        ...
        public static double GetOdds(List<Data.Card> playerCards, int playerAmount)
        {
            ...
            playerAmount--; //Since the odds for an opponent are at position 0 in the table, etc.
        ...
        private static string ParseCards(List<Data.Card> playerCards)
        {
            if (playerCards.Count != 2)
                throw new ArgumentException("There are always only 2 hole cards!!");
