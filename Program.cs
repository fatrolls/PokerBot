...
namespace Bot
{
    internal class MainClass
    {
        ...
        public static void Main(string[] args)
        {
            ...
            ThreadStart start = () => HandleGetter.FindHandles("PokerStars", "No Limit Hold'em", ref sema);
            var myThread = new Thread(start);
            myThread.Start();

            ThreadStart start_readMemoryThread = () => ReadMemory.OpenProcess("PokerStars", "No Limit Hold'em");
            var myThread2 = new Thread(start_readMemoryThread);
            myThread2.Start();
