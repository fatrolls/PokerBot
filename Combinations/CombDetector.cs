    ...
    internal static class CombDetector
    {
        ...
        private static void FindStraight()
        {
            ...
            for (var i = 0; i < 13; i++)
            {
                ...
                if (straight.Last().Value == Value.Ace)
        ...
        private static void ShiftValueList()
        {
            ...
            //Eine Straße kann nämlich auch von einem Ace aus starten.

            if (!_values.ContainsKey((int) Value.Ace)) return;
            var ace = _values[(int) Value.Ace];
